...
const (
	...
	// LatestTimeVscPaketByteKey is the byte prefix that will store last block time reception of VCS IBC packet
	LatestTimeVscPaketByteKey
)
...
func LatestTimeVscPaketKey() []byte {
	return []byte{LatestTimeVscPaketByteKey}
}
